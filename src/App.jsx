  ...
  const cssProperties = [
    {
      ...
      properties: [
        ...
        { property: 'top', values: 'auto, 0, 10px, 50%, 100%, inherit, initial, unset', description: 'Top position offset' },
        { property: 'right', values: 'auto, 0, 10px, 50%, 100%, inherit, initial, unset', description: 'Right position offset' },
        { property: 'bottom', values: 'auto, 0, 10px, 50%, 100%, inherit, initial, unset', description: 'Bottom position offset' },
        { property: 'left', values: 'auto, 0, 10px, 50%, 100%, inherit, initial, unset', description: 'Left position offset' },
    ...
    },
    {
      ...
      properties: [
        ...
        { property: 'margin', values: '0, 10px, 1em, auto, inherit, initial, unset', description: 'Margin shorthand' },
        { property: 'margin-top', values: '0, 10px, 1em, auto, inherit, initial, unset', description: 'Top margin' },
        { property: 'margin-right', values: '0, 10px, 1em, auto, inherit, initial, unset', description: 'Right margin' },
        { property: 'margin-bottom', values: '0, 10px, 1em, auto, inherit, initial, unset', description: 'Bottom margin' },
        { property: 'margin-left', values: '0, 10px, 1em, auto, inherit, initial, unset', description: 'Left margin' },
        { property: 'padding', values: '0, 10px, 1em, inherit, initial, unset', description: 'Padding shorthand' },
        { property: 'padding-top', values: '0, 10px, 1em, inherit, initial, unset', description: 'Top padding' },
        { property: 'padding-right', values: '0, 10px, 1em, inherit, initial, unset', description: 'Right padding' },
        { property: 'padding-bottom', values: '0, 10px, 1em, inherit, initial, unset', description: 'Bottom padding' },
        { property: 'padding-left', values: '0, 10px, 1em, inherit, initial, unset', description: 'Left padding' },
    ...
    },
    {
      category: 'Flexbox',
      properties: [
        { property: 'display: flex', values: 'flex, inline-flex', description: 'Flex container' },
        { property: 'flex-direction', values: 'row, row-reverse, column, column-reverse, inherit, initial, unset', description: 'Flex direction' },
        { property: 'flex-wrap', values: 'nowrap, wrap, wrap-reverse, inherit, initial, unset', description: 'Flex wrapping' },
        { property: 'flex-flow', values: 'row nowrap, column wrap, inherit, initial, unset', description: 'Flex direction and wrap shorthand' },
        { property: 'justify-content', values: 'flex-start, flex-end, center, space-between, space-around, space-evenly, start, end, left, right, inherit, initial, unset', description: 'Main axis alignment' },
        { property: 'align-items', values: 'stretch, flex-start, flex-end, center, baseline, first baseline, last baseline, start, end, self-start, self-end, inherit, initial, unset', description: 'Cross axis alignment' },
        { property: 'align-content', values: 'flex-start, flex-end, center, space-between, space-around, space-evenly, stretch, start, end, baseline, first baseline, last baseline, inherit, initial, unset', description: 'Multi-line alignment' },
        { property: 'align-self', values: 'auto, flex-start, flex-end, center, baseline, stretch, inherit, initial, unset', description: 'Individual item alignment' },
        { property: 'flex-grow', values: '0, 1, 2, inherit, initial, unset', description: 'Growth factor' },
        { property: 'flex-shrink', values: '0, 1, 2, inherit, initial, unset', description: 'Shrink factor' },
        { property: 'flex-basis', values: 'auto, 0, 100px, 50%, content, inherit, initial, unset', description: 'Initial size' },
        { property: 'flex', values: '0 1 auto, 1, 1 0 100px, none, inherit, initial, unset', description: 'Flex shorthand' },
        { property: 'order', values: '0, 1, -1, inherit, initial, unset', description: 'Flex item order' }
      ]
    },
    {
      category: 'Grid',
      properties: [
        { property: 'display: grid', values: 'grid, inline-grid, subgrid', description: 'Grid container' },
        { property: 'grid-template-columns', values: 'none, 1fr, 100px, repeat(3, 1fr), minmax(100px, 1fr), inherit, initial, unset', description: 'Column definitions' },
        { property: 'grid-template-rows', values: 'none, 1fr, 100px, repeat(3, 1fr), minmax(100px, 1fr), inherit, initial, unset', description: 'Row definitions' },
        { property: 'grid-template-areas', values: 'none, "header header" "sidebar main", inherit, initial, unset', description: 'Area definitions' },
        { property: 'grid-template', values: 'none, "header header" 100px / 1fr 1fr, inherit, initial, unset', description: 'Grid template shorthand' },
        { property: 'grid-column-gap', values: '0, 10px, 1em, inherit, initial, unset', description: 'Column gaps (deprecated)' },
        { property: 'grid-row-gap', values: '0, 10px, 1em, inherit, initial, unset', description: 'Row gaps (deprecated)' },
        { property: 'grid-gap', values: '0, 10px, 10px 20px, inherit, initial, unset', description: 'Grid gaps shorthand (deprecated)' },
        { property: 'gap', values: '0, 10px, 10px 20px, inherit, initial, unset', description: 'Grid and flexbox gaps' },
        { property: 'row-gap', values: '0, 10px, 1em, inherit, initial, unset', description: 'Row gaps' },
        { property: 'column-gap', values: '0, 10px, 1em, inherit, initial, unset', description: 'Column gaps' },
        { property: 'grid-column', values: 'auto, 1, 1 / 3, span 2, inherit, initial, unset', description: 'Column placement' },
        { property: 'grid-row', values: 'auto, 1, 1 / 3, span 2, inherit, initial, unset', description: 'Row placement' },
        { property: 'grid-column-start', values: 'auto, 1, span 2, inherit, initial, unset', description: 'Column start position' },
        { property: 'grid-column-end', values: 'auto, 1, span 2, inherit, initial, unset', description: 'Column end position' },
        { property: 'grid-row-start', values: 'auto, 1, span 2, inherit, initial, unset', description: 'Row start position' },
        { property: 'grid-row-end', values: 'auto, 1, span 2, inherit, initial, unset', description: 'Row end position' },
        { property: 'grid-area', values: 'auto, 1, header, inherit, initial, unset', description: 'Grid area shorthand' },
        { property: 'justify-items', values: 'start, end, center, stretch, inherit, initial, unset', description: 'Item alignment on inline axis' },
        { property: 'align-items', values: 'start, end, center, stretch, inherit, initial, unset', description: 'Item alignment on block axis' },
        { property: 'justify-self', values: 'auto, start, end, center, stretch, inherit, initial, unset', description: 'Individual item alignment on inline axis' },
        { property: 'align-self', values: 'auto, start, end, center, stretch, inherit, initial, unset', description: 'Individual item alignment on block axis' },
        { property: 'justify-content', values: 'start, end, center, stretch, space-around, space-between, space-evenly, inherit, initial, unset', description: 'Content alignment on inline axis' },
        { property: 'align-content', values: 'start, end, center, stretch, space-around, space-between, space-evenly, inherit, initial, unset', description: 'Content alignment on block axis' },
        { property: 'grid-auto-columns', values: 'auto, 100px, 1fr, minmax(100px, 1fr), inherit, initial, unset', description: 'Auto-generated column size' },
        { property: 'grid-auto-rows', values: 'auto, 100px, 1fr, minmax(100px, 1fr), inherit, initial, unset', description: 'Auto-generated row size' },
        { property: 'grid-auto-flow', values: 'row, column, row dense, column dense, inherit, initial, unset', description: 'Auto-placement algorithm' }
      ]
    },
    {
      category: 'Typography',
    ...
    },
    {
      ...
      properties: [
        ...
        { property: 'text-align', values: 'left, right, center, justify, start, end, inherit, initial, unset', description: 'Text alignment' },
        { property: 'text-align-last', values: 'auto, left, right, center, justify, start, end, inherit, initial, unset', description: 'Last line alignment' },
    ...
    },
    {
      ...
      properties: [
        { property: 'transform', values: 'none, translate(10px), rotate(45deg), scale(2), skew(10deg), inherit, initial, unset', description: 'Element transformation' },
        { property: 'transform-origin', values: 'center, top left, 50% 50%, inherit, initial, unset', description: 'Transform origin' },
        ...
        { property: 'translate', values: 'none, 10px, 10px 20px, inherit, initial, unset', description: 'Translate shorthand' },
        { property: 'rotate', values: 'none, 45deg, inherit, initial, unset', description: 'Rotate shorthand' },
        { property: 'scale', values: 'none, 2, 2 3, inherit, initial, unset', description: 'Scale shorthand' },
        { property: 'skew', values: 'none, 10deg, 10deg 20deg, inherit, initial, unset', description: 'Skew shorthand' }
      ]
    },
    {
    ...
    },
    {
      category: 'Tables',
      properties: [
        { property: 'table-layout', values: 'auto, fixed, inherit, initial, unset', description: 'Table layout algorithm' },
        { property: 'border-collapse', values: 'separate, collapse, inherit, initial, unset', description: 'Border collapse' },
        { property: 'border-spacing', values: '0, 10px, 10px 20px, inherit, initial, unset', description: 'Border spacing' },
        { property: 'caption-side', values: 'top, bottom, inherit, initial, unset', description: 'Caption side' },
        { property: 'empty-cells', values: 'show, hide, inherit, initial, unset', description: 'Empty cells' }
      ]
    },
    {
      category: 'Lists',
      properties: [
        { property: 'list-style', values: 'disc outside none, inherit, initial, unset', description: 'List style shorthand' },
        { property: 'list-style-type', values: 'disc, circle, square, decimal, lower-alpha, upper-alpha, inherit, initial, unset', description: 'List style type' },
        { property: 'list-style-position', values: 'outside, inside, inherit, initial, unset', description: 'List style position' },
        { property: 'list-style-image', values: 'none, url(image.jpg), inherit, initial, unset', description: 'List style image' }
      ]
    },
    {
      category: 'Counters',
