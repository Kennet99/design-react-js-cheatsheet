  ...
  return (
    <div className="section">
      ...
      <div className="concept-card">
        ...
        <div className="explanation">CSS-in-JS allows you to write CSS directly in JavaScript, combining styling with component logic.</div>
  ...
  return (
    <div>
      ...
      <div className="concept-card">
        ...
        <div className="explanation">CSS Modules provide scoped styling that only applies to specific components, preventing style conflicts.</div>
...
<Button variant="secondary">Secondary Button</Button>`}
      ...
      <div className="concept-card">
        ...
        <div className="explanation">Tailwind CSS provides utility classes that you combine to build designs, similar to how you use design tokens in Figma.</div>
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="concept-card">
        ...
        <div className="explanation">Responsive design ensures your UI works well on all screen sizes, from mobile to desktop.</div>
